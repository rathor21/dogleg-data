...
**Tweet 1** (248 chars) [attach 002_chart5_quote_card.png]
...
## Alternative launch (four verdicts, link in reply, 275 chars)
...
## Quote-post for the calculator (matches the caption's alternate)
